...
| 지표 | 수치 | 비고 |
|------|------|------|
| **총 코드 라인** | **35,000+** | Dart 31,650 + TypeScript 1,882 + Java/XML 887 + Swift 330 + JS 737 |
...
| **i18n** | **한국어 + 영어** | Flutter ARB `gen-l10n`, 500+ 번역 키, 타입 안전 getter |
...
| **Dart 라인 수** | **31,650** | `find lib -name '*.dart' \| xargs cat \| wc -l` |
