...
[![Docs](https://img.shields.io/badge/Docs-41%20문서-00b894?logo=readthedocs&logoColor=white)](https://monkshark.github.io/hansol_hs_flutter_app/)
...
| 지표 | 수치 | 비고 |
|------|------|------|
| **기술 문서** | **[41개](https://monkshark.github.io/hansol_hs_flutter_app/)** | main · 서비스 · 모델 · API · 알림 등 MD 문서 + 인터랙티브 뷰어 (화면/위젯 제외) |
| **총 코드 라인** | **35,500+** | Dart 32,094 + TypeScript 1,882 + Java/XML 887 + Swift 330 + JS 485 |
| **소스 파일** | **104개** (Flutter) + **12페이지** (Admin Web) + **5개** (Android Widget) + **1개** (iOS Widget) | 27 screens, 15 추출 위젯, 49 models/utils/services + i18n 7 |
...
| **Dart 라인 수** | **32,094** | `find lib -name '*.dart' \| xargs cat \| wc -l` |
| **Dart 파일 수** | **104개** | `find lib -name '*.dart' \| wc -l` |
| **Unit/Widget test 실행 시간** | **약 6초** | `flutter test` 146 tests, 로컬 머신 기준 |
