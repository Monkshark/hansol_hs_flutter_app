...
### 처음 기여하는 팀원
1. [제품 개요](./docs/guides/product-overview.md) — 앱의 존재 이유와 범위
2. [아키텍처 개요](./docs/guides/architecture-overview.md) — 시스템 그림, Riverpod 그래프, 데이터 흐름
3. [아키텍처 의사결정 일지](./docs/guides/architecture-decisions.md) — 8개 ADR
...
- [인증 & 접근](./docs/guides/account-and-access.md) — 역할·승인·탈퇴

### 운영 / 배포 담당자
- [배포 가이드](./DEPLOY.md) — rules / functions / 앱 / 관리자 웹
- [CI/CD 설정](./docs/guides/cicd-setup.md) — GitHub Actions 두 워크플로우
- [보안 모델](./docs/guides/security.md) — Firestore rules, 개인정보
- [아키텍처 개요](./docs/guides/architecture-overview.md)

### 기타 심화 문서
- [데이터 모델](./docs/guides/data-model.md) — 컬렉션 스키마 + 인덱스 + rules 연관
- [테스트 전략](./docs/guides/testing.md) — 524 Flutter + 34 Rules 테스트
- [기술 과제 14건](./docs/guides/technical-challenges.md) — 실제 문제 해결 사례
- [스크린샷 갤러리](./docs/guides/screenshots-gallery.md) — 전체 UI 투어

### 파일별 기술 레퍼런스
> 서비스·모델·API·알림 등 핵심 계층 파일별 상세 문서 (특정 파일을 수정하거나 동작 흐름을 추적할 때)

- [📚 API Reference 전체 목차](./docs/README.md) — 아래 항목 통합 인덱스
- [`main.md`](./docs/main.md) — 앱 진입점, MainScreen, 전역 상태
- **API 계층** (`docs/api/`): [meal_data_api](./docs/api/meal_data_api.md) · [timetable_data_api](./docs/api/timetable_data_api.md) · [notice_data_api](./docs/api/notice_data_api.md)
- **데이터 계층** (`docs/data/`): [auth_service](./docs/data/auth_service.md) · [grade_manager](./docs/data/grade_manager.md) · [local_database](./docs/data/local_database.md) · [post_repository](./docs/data/post_repository.md) · [search_tokens](./docs/data/search_tokens.md) · [service_locator](./docs/data/service_locator.md) · [setting_data](./docs/data/setting_data.md) · 외 다수
- **알림** (`docs/notification/`): [fcm_service](./docs/notification/fcm_service.md) · [daily_meal_notification](./docs/notification/daily_meal_notification.md) · [popup_notice](./docs/notification/popup_notice.md) · [update_checker](./docs/notification/update_checker.md)
- **상태 관리** (`docs/providers/`): [providers](./docs/providers/providers.md) — Riverpod Notifier/AsyncNotifier 전체
- **네트워크** (`docs/network/`): [network_status](./docs/network/network_status.md) · [offline_queue_manager](./docs/network/offline_queue_manager.md)
- **스타일** (`docs/styles/`): [app_colors](./docs/styles/app_colors.md) · [dark_app_colors](./docs/styles/dark_app_colors.md) · [light_app_colors](./docs/styles/light_app_colors.md)
...
전체 스크린샷 → [스크린샷 갤러리](./docs/guides/screenshots-gallery.md)
...
- **Riverpod Provider 의존성 그래프**, **데이터 흐름 계층 모델** → [architecture-overview.md](./docs/guides/architecture-overview.md)
- 저장소 분담(sqflite/Firestore/SecureStorage/Storage) 설계 근거 → [ADR-06](./docs/guides/architecture-decisions.md)
...
전체 상세는 [architecture-decisions.md](./docs/guides/architecture-decisions.md).
...
자세한 내용은 [security.md](./docs/guides/security.md).
...
상세: [testing.md](./docs/guides/testing.md), [cicd-setup.md](./docs/guides/cicd-setup.md).
...
컬렉션 스키마 + 인덱스 + 보안 규칙 연관은 [data-model.md](./docs/guides/data-model.md).
...
**전체 14건**: [technical-challenges.md](./docs/guides/technical-challenges.md)
