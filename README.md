...
### 처음 기여하는 팀원
1. [제품 개요](./docs/index.html#guides/product-overview.md) — 앱의 존재 이유와 범위
2. [아키텍처 개요](./docs/index.html#guides/architecture-overview.md) — 시스템 그림, Riverpod 그래프, 데이터 흐름
3. [아키텍처 의사결정 일지](./docs/index.html#guides/architecture-decisions.md) — 8개 ADR
4. 피처 상세: [공개](./docs/index.html#features/public-features.md) / [커뮤니티](./docs/index.html#features/community-features.md) / [개인](./docs/index.html#features/personal-features.md) / [관리자](./docs/index.html#features/admin-features.md)
5. [기여 가이드](./CONTRIBUTING.md)

### 엔드유저 (재학생 / 교사 / 졸업생 / 학부모)
- [사용자 가이드](./USER_GUIDE.md) — 가입부터 주요 기능까지
- [공개 기능](./docs/index.html#features/public-features.md) — 급식/시간표/학사일정
- [인증 & 접근](./docs/index.html#guides/account-and-access.md) — 역할·승인·탈퇴

### 운영 / 배포 담당자
- [배포 가이드](./DEPLOY.md) — rules / functions / 앱 / 관리자 웹
- [CI/CD 설정](./docs/index.html#guides/cicd-setup.md) — GitHub Actions 두 워크플로우
- [보안 모델](./docs/index.html#guides/security.md) — Firestore rules, 개인정보
- [아키텍처 개요](./docs/index.html#guides/architecture-overview.md)

### 기타 심화 문서
- [데이터 모델](./docs/index.html#guides/data-model.md) — 컬렉션 스키마 + 인덱스 + rules 연관
- [테스트 전략](./docs/index.html#guides/testing.md) — 524 Flutter + 34 Rules 테스트
- [기술 과제 14건](./docs/index.html#guides/technical-challenges.md) — 실제 문제 해결 사례
- [스크린샷 갤러리](./docs/index.html#guides/screenshots-gallery.md) — 전체 UI 투어

### 파일별 기술 레퍼런스
> 서비스·모델·API·알림 등 핵심 계층 파일별 상세 문서 (특정 파일을 수정하거나 동작 흐름을 추적할 때)

- [📚 API Reference 전체 목차](./docs/index.html#README.md) — 아래 항목 통합 인덱스
- [`main.md`](./docs/index.html#main.md) — 앱 진입점, MainScreen, 전역 상태
- **API 계층** (`docs/api/`): [meal_data_api](./docs/index.html#api/meal_data_api.md) · [timetable_data_api](./docs/index.html#api/timetable_data_api.md) · [notice_data_api](./docs/index.html#api/notice_data_api.md)
- **데이터 계층** (`docs/data/`): [auth_service](./docs/index.html#data/auth_service.md) · [grade_manager](./docs/index.html#data/grade_manager.md) · [local_database](./docs/index.html#data/local_database.md) · [post_repository](./docs/index.html#data/post_repository.md) · [search_tokens](./docs/index.html#data/search_tokens.md) · [service_locator](./docs/index.html#data/service_locator.md) · [setting_data](./docs/index.html#data/setting_data.md) · 외 다수
- **알림** (`docs/notification/`): [fcm_service](./docs/index.html#notification/fcm_service.md) · [daily_meal_notification](./docs/index.html#notification/daily_meal_notification.md) · [popup_notice](./docs/index.html#notification/popup_notice.md) · [update_checker](./docs/index.html#notification/update_checker.md)
- **상태 관리** (`docs/providers/`): [providers](./docs/index.html#providers/providers.md) — Riverpod Notifier/AsyncNotifier 전체
- **네트워크** (`docs/network/`): [network_status](./docs/index.html#network/network_status.md) · [offline_queue_manager](./docs/index.html#network/offline_queue_manager.md)
- **스타일** (`docs/styles/`): [app_colors](./docs/index.html#styles/app_colors.md) · [dark_app_colors](./docs/index.html#styles/dark_app_colors.md) · [light_app_colors](./docs/index.html#styles/light_app_colors.md)
...
전체 스크린샷 → [스크린샷 갤러리](./docs/index.html#guides/screenshots-gallery.md)
...
- **Riverpod Provider 의존성 그래프**, **데이터 흐름 계층 모델** → [architecture-overview.md](./docs/index.html#guides/architecture-overview.md)
- 저장소 분담(sqflite/Firestore/SecureStorage/Storage) 설계 근거 → [ADR-06](./docs/index.html#guides/architecture-decisions.md)
...
전체 상세는 [architecture-decisions.md](./docs/index.html#guides/architecture-decisions.md).
...
| 카테고리 | 주요 항목 | 상세 |
|---|---|---|
| **공개** | 급식, 시간표, 학사일정, 긴급 팝업, 홈 위젯(Android/iOS), 오프라인 | [public-features.md](./docs/index.html#features/public-features.md) |
| **커뮤니티** | 게시판(6카테고리 + 인기글 + n-gram 검색), 1:1 채팅, 알림, 건의사항 | [community-features.md](./docs/index.html#features/community-features.md) |
| **개인** | 성적(수시/정시, 로컬 전용), 개인일정, D-day, 프로필 | [personal-features.md](./docs/index.html#features/personal-features.md) |
| **관리자** | Flutter Admin + Next.js Admin Web, 승인/정지/신고/건의/감사 로그 | [admin-features.md](./docs/index.html#features/admin-features.md) |
...
자세한 내용은 [security.md](./docs/index.html#guides/security.md).
...
상세: [testing.md](./docs/index.html#guides/testing.md), [cicd-setup.md](./docs/index.html#guides/cicd-setup.md).
...
컬렉션 스키마 + 인덱스 + 보안 규칙 연관은 [data-model.md](./docs/index.html#guides/data-model.md).
...
**전체 14건**: [technical-challenges.md](./docs/index.html#guides/technical-challenges.md)
