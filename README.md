...
| 지표 | 수치 | 비고 |
|------|------|------|
| **총 코드 라인** | **19,000+** | Dart 16,800 + TypeScript 1,900 + JS 290 |
| **소스 파일** | **63개** (Flutter) + **11페이지** (Admin Web) | 25 screens, 38 models/utils/widgets |
...
- iOS 위젯 코드 준비 완료 (SwiftUI, Xcode에서 타겟 추가 필요)
</details>
