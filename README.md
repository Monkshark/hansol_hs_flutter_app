...
| **테스트** | **131 + 34개** | Flutter Unit/Widget/Provider 131 + Firestore Rules emulator 34 (총 165) |
...
| 구분 | 내용 |
|------|------|
| **Unit Test** | 모델 직렬화, 등급 변환, 급식 파싱, 시간표 교시 계산, 검색 토크나이저, secure_storage 마이그레이션 등 (89개) |
