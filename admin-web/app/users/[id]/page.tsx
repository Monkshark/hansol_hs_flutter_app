          ...
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              <div className="flex items-center gap-2">
                ...
                {suspended && <Badge label="정지" className="bg-red-100 text-red-600" />}
              </div>
        ...
        <div className="bg-white rounded-xl p-6 shadow-sm">
          ...
          {posts.length === 0 ? (
            ...
            <div className="space-y-2">
              {posts.map(p => (
                <div key={p.id} className="p-3 bg-gray-50 rounded-lg cursor-pointer hover:bg-gray-100 flex items-center gap-3"
                  onClick={() => router.push(`/posts/${p.id}`)}>
                  <Badge label={p.category} className="bg-blue-100 text-blue-600" />
