...
**주의**: 규칙 변경은 실배포 즉시 반영됩니다. 반드시 [testing.md](https://monkshark.github.io/hansol_hs_flutter_app/#guides/testing.md)의 34개 rules 테스트 통과 확인 후 배포하세요. 관련 배경: [security.md](https://monkshark.github.io/hansol_hs_flutter_app/#guides/security.md).
...
Functions 목록은 [architecture-overview.md](./docs/guides/architecture-overview.md#cloud-functions-트리거-맵) 참조.
...
**절대 커밋 금지**: 실제 키 파일은 `.gitignore` 처리 확인. CI는 더미 값으로 빌드만 검증합니다 ([cicd-setup.md](https://monkshark.github.io/hansol_hs_flutter_app/#guides/cicd-setup.md)).
...
- [보안 모델](https://monkshark.github.io/hansol_hs_flutter_app/#guides/security.md)
