...
| 항목 | 수치 |
|---|---|
| 총 코드 라인 | 26,200+ (Dart 22,367 + TS 1,882 + Java/XML 887 + Swift 330 + JS 737) |
| 소스 파일 | 91 (Flutter) + 12 (Admin Web) + 5 (Android Widget) + 1 (iOS Widget) |
| Cloud Functions | 8개 |
| OAuth 로그인 | 4종 (Google / Apple / Kakao / GitHub) |
| 푸시 알림 | 13종 (FCM 10 + 로컬 3) |
| 테스트 | 146 Flutter + 34 Rules = 180개 |
