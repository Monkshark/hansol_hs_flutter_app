...
- **관련 파일**: `lib/network/secure_storage_service.dart` (예상 경로), `test/secure_storage_service_test.dart`
...
- **Golden (5)**: PostCard 스냅샷 비교 (`fake_cloud_firestore` + tolerance comparator)
...
- **합계**: 146 (Flutter) + 34 (Rules) = **180개**. 상세 분류는 [testing.md](./testing.md) 참조.
