...
| Item | Value |
|---|---|
| Total LOC | 26,200+ (Dart 22,367 + TS 1,882 + Java/XML 887 + Swift 330 + JS 737) |
| Source files | 91 (Flutter) + 12 (Admin Web) + 5 (Android Widget) + 1 (iOS Widget) |
| Cloud Functions | 8 |
| OAuth providers | 4 (Google / Apple / Kakao / GitHub) |
| Push types | 13 (FCM 10 + local 3) |
| Tests | 146 Flutter + 34 Rules = 180 |
